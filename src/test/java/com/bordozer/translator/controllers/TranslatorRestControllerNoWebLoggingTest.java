...
@TestPropertySource(properties = {
        "application.properties.logging.logRequest=false",
        "application.properties.logging.logResponse=false",
})
class TranslatorRestControllerNoWebLoggingTest extends AbstractEndpointTest {
    ...
    void shouldTranslateAndGenerateRequestId() {
        ...
        verify(webLogger, never()).logRequest(any(WebLogger.RequestLogData.class));
        verify(webLogger, never()).logResponse(any(WebLogger.ResponseLogData.class));
    }
